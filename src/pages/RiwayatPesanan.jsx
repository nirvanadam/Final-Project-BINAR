              ...
              {data &&
                data.map((datas, index) => {
                  return (
                    <div
                      key={index}
                      className="flex flex-col  p-4 border border-gray-400 rounded-lg"
                    >
                      <h1 className="mb-5 w-fit px-3 py-1 rounded-full bg-red-600 text-white text-sm font-semibold">
