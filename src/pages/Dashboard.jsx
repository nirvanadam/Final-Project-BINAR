...
function Dashboard() {
  ...
  const handleDataSubmitPassenger = (dataPassenger) => {
    setSubmitedDataPassenger(dataPassenger + " Penumpang");
  };
  // Passenger Logic End
  ...
  return (
    <>
      ...
      {isOpenPassengers ? <ModalPassenger action={handleClosePassengers} onDataSubmit={handleDataSubmitPassenger} /> : null}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 grid-rows-2 gap-6 lg:gap-y-16 lg:gap-x-12 justify-center items-center">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="lg:relative grid grid-cols-[35px,1fr] gap-5 ">
                  ...
                  <input onClick={handlePassengers} type="" name="" id="" value={submitedDataPassenger} className="self-end w-full h-10 bg-transparent border border-t-0 border-x-0 border-slate-400 font-semibold outline-none" />
                </div>
                {/* Passenger */}
