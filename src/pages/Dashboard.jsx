...
function Dashboard() {
  ...
  return (
    <>
      ...
      {isOpenSeatClass ? <ModalSeatClass action={handleCloseSeatClass} /> : null}
      {isOpenPassengers ? <ModalPassenger action={handleClosePassengers} /> : null}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 grid-rows-2 gap-6 lg:gap-y-16 lg:gap-x-12 justify-center items-center">
              ...
              <div className="grid grid-cols-[35px,1fr] gap-5">
                ...
                <div className="relative self-end lg:ml-10">
                  <input onClick={handleFrom} type="text" name="" id="" placeholder="From" className="self-end w-[85%] h-10 bg-transparent border border-t-0 border-x-0 border-slate-400 outline-none group-focus/input:opacity-100" />
              ...
              <div className="grid grid-cols-[35px,1fr] gap-5">
                ...
                <div className="lg:ml-10">
                  <input onClick={handleTo} type="text" name="" id="" className="self-end w-full h-10 bg-transparent border border-t-0 border-x-0 border-slate-400 outline-none" />
                </div>
              </div>
              {/* To End */}
