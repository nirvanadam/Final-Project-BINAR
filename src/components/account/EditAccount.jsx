...
function EditAccount(props) {
  ...
  return (
    <div className="lg:block border border-gray-200 shadow-md rounded-lg py-5 px-1 lg:px-4">
      <h1 className="hidden lg:block text-xl font-bold mb-4">Ubah Data Profile</h1>
